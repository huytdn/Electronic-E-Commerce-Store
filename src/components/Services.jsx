...
import refund from "../assets/Images/return.png";
...
const Services = () => {
  ...
  return (
    <div className="w-full lg:px-20 px-5 pt-[90px] pb-[80px] grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10">
      <div
        data-aos="zoom-in"
        data-aos-delay="100"
