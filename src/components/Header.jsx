...
const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="w-full bg-gray-100 flex justify-between items-center gap-10 lg:px-16 px-6 py-5 sticky top-0  z-50">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="bg-themepurple hover:bg-themeyellow px-3 py-1 text-white hover:text-black rounded-full absolute top-[-20px] right-[-20px] text-[14px]  font-bold">
              2
            </div>
          </div>
        </div>
