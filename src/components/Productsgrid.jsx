...
const Productsgrid = () => {
  ...
  return (
    <div
      id="products"
      className="w-full lg:px-20 px-5 pt-[80px] bg-gray-100 flex flex-col justify-center items-center gap-4"
    >
      <h1
        data-aos="zoom-in"
        data-aos-delay="100"
      ...
      >
        {products.map((item, index) => (
          ...
          >
            ...
            >
              <div className="bg-themepurple hover:bg-themeyellow hover:text-black hover:text-rounded-full p-3 text-white">
      ...
      <button
        data-aos="zoom-in"
        data-aos-delay="400"
        className="bg-themepurple hover:bg-themeyellow text-white hover:text-black font-semibold px-8 py-3 rounded-lg mt-8 mb-20"
      >
        VIEW MORE
      </button>
    </div>
